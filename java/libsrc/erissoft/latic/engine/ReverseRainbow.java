/*********************************************************************
 *
 *  File Name: ReverseRainbow.java
 *
 *  Description: Reverse rainbow color iterator 
 *
...
public class ReverseRainbow extends Rainbow {

    public ReverseRainbow() { 
        this(1);
    }

    public ReverseRainbow(int step) { 
        super(step, new Color(Color.VIOLET), RANGE_.END_);
    }

    public boolean hasNext() { return range_ != RANGE_.RED_; }
